...
\begin{figure}[!hbt]
	\begin{center}
		\includegraphics[width=0.4\textwidth]{img/FMFI_logo_BP.png}
		\label{img:logo}
	\end{center}
\end{figure}
\begin{center}
...
\newpage 
\thispagestyle{empty}
\hspace{-2cm}\includegraphics[page=1,width=1.1\textwidth]{zadanie-prace-en.pdf}

\newpage 
\thispagestyle{empty}
\hspace{-2cm}\includegraphics[page=2,width=1.1\textwidth]{zadanie-prace-en.pdf}

\newpage 
\thispagestyle{empty}
\hspace{-2cm}\includegraphics[page=1,width=1.1\textwidth]{zadanie-prace-sk.pdf}

\newpage 
\thispagestyle{empty}
\hspace{-2cm}\includegraphics[page=2,width=1.1\textwidth]{zadanie-prace-sk.pdf}
